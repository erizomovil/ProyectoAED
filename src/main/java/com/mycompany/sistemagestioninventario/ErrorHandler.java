...
public class ErrorHandler extends javax.swing.JFrame {
    ...
    public ErrorHandler(String ERROR,Exception e) {
        initComponents();
        this.error = e;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Print on console");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorHandler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Exception e = null;
                new ErrorHandler("ERROR", e).setVisible(true);
            }
        });
    }
